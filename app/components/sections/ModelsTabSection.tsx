          ...
          >
            ...
            >
              ...
              <div>
                ...
                <h3 className="text-4xl sm:text-5xl font-bold text-slate-800 mb-2">
                  {activeModel.name}
                </h3>
              ...
              {/* Pricing - Simple Display */}
              <div className="bg-electric-blue/10 rounded-xl p-6 border-2 border-electric-blue/20">
                <div className="text-center">
                  <div className="text-sm text-slate-600 mb-2">Harga</div>
                  <div className="text-4xl font-bold text-electric-blue mb-4">{activeModel.price}</div>
                  <Button
                    href="#financing"
                    variant="outline"
                    size="large"
